        ...
        <section>
            ...
            <div className=' items-center justify-center'>
                <form onSubmit={handleSubmit(onSubmit)}>
                    <input className='mb-2 appearance-none rounded-none relative block w-full px-3 py-2 border border-slate-500  text-gray-900 rounded-t-md focus:outline-none focus:ring-violet-500 focus:border-violet-500 focus:z-10 sm:text-sm' placeholder='Your Image URL' type="text" {...register("userImage")} />
                    ...
                    <input className='mb-2 uppercase appearance-none rounded-none relative block w-full px-5 py-2 border border-slate-500  text-gray-900 rounded-t-md focus:outline-none focus:ring-violet-500 focus:border-violet-500 focus:z-10 sm:text-sm' placeholder='product name' type='text' {...register("productName")} />
